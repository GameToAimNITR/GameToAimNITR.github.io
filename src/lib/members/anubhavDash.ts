...
export const anubhavDash: Member = {
  id: 29,
  name: 'Anubhav Dash',
  role: 'Design, Code and Audio Team',
  year: 2029,
  image: '/members/Anubhav_Dash.png',
  aiHint: 'environment artist developer',
  skills: [
    { name: 'Environment Modeling', level: 87 },
