...
export const rajeshPuripanda: Member = {
  id: 35,
  name: 'Rajesh Puripanda',
  role: 'Creative Head, Code and Design Team',
  year: 2029,
  image: '/members/Rajesh_Puripanda.png',
  aiHint: 'creative head developer designer',
  skills: [
