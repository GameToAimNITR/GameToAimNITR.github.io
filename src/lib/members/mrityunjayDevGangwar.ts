...
export const mrityunjayDevGangwar: Member = {
  id: 32,
  name: 'Mrityunjay Dev Gangwar',
  role: 'Code Team',
  year: 2029,
  image: '/members/Mrityunjay_Dev_Gangwar.png',
  aiHint: 'game developer coder',
  skills: [
    { name: 'Game Programming', level: 78 },
